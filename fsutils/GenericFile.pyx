...
class File(Path):
    ...
    def __init__(self, path: str | Path, encoding="utf-8", *args, **kwargs) -> None:
        """Construct the GenericFile.File object.
    ...
    def is_image(self) -> bool:
        ...
        return self.suffix.lower() in mimecfg.FILE_TYPES["img"]

    @property
    def is_video(self) -> bool:
        """Check if the file is a video."""
        return all((self.suffix.lower() in mimecfg.FILE_TYPES["video"], self.__class__.__name__ == "VideoFile.Video"))
