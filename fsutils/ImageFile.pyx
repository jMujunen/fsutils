...
class Img(GenericFile.File):
    ...
    def __init__(self, path: str | Path) -> None:
        """Initialize an ImageFile.Img object.
    ...
    def compress(
        ...
        Returns
        -------
            - `ImageFile.Img`: A new instance of the ImageFile.Img class with the compressed image path and dimensions
    ...
    def fmtheader() -> str:
        ...
        header = template.format("GenericFile.File", "Ext", "Size", "Dimensions", "Capture Date")
